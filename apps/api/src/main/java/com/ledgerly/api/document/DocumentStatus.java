 ...
 * same rules. {@code EXTRACTED}, {@code NEEDS_REVIEW} and {@code FAILED} are terminal: a document
 * that already failed is never silently retried into a different outcome, which would make the
