...
EMBED_QUERY_REQUEST_SCHEMA = "embed-query-request.schema.json"
EMBED_QUERY_RESPONSE_SCHEMA = "embed-query-response.schema.json"
CATEGORIZE_REQUEST_SCHEMA = "categorize-request.schema.json"
CATEGORIZE_RESPONSE_SCHEMA = "categorize-response.schema.json"
ANOMALY_REQUEST_SCHEMA = "anomaly-request.schema.json"
ANOMALY_RESPONSE_SCHEMA = "anomaly-response.schema.json"
